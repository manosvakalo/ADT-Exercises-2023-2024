...
int BSTceiling(BinTreePointer Root,BinTreeElementType key);
int BSTfloor(BinTreePointer Root,BinTreeElementType key);


int main()
{
    BinTreePointer NumbersTree;
    CreateBST(&NumbersTree);
    BinTreeElementType item;

    printf("Enter a number to insert: ");
    scanf("%d",&item);
    while(item > 0 ){
        RecBSTInsert(&NumbersTree,item);
        printf("Enter a number to insert: ");
        scanf("%d",&item);
    }
    ...
    scanf("%d",&item);
    while(item > 0 ){
    printf("Ceiling: %d\n",BSTceiling(NumbersTree,item));
    printf("Floor: %d\n",BSTfloor(NumbersTree,item));
    printf("Enter a number to search: ");
    scanf("%d",&item);
    }
...
int BSTceiling(BinTreePointer Root,BinTreeElementType key)
{
    ...
    if(Root->Data < key) return BSTceiling(Root->RChild,key);

    int ceilValue = BSTceiling(Root->LChild,key);

    return(ceilValue == -1) ? Root->Data : ceilValue;
}
...
int BSTfloor(BinTreePointer Root,BinTreeElementType key)
{
    ...
    if(Root->Data > key) return BSTfloor(Root->LChild,key);

    int floorValue = BSTfloor(Root->RChild,key);

    return (floorValue == -1) ? Root->Data : floorValue;
